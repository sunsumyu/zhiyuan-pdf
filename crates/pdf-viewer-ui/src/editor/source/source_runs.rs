...
use crate::editor::source_geometry::{source_run_visual_bbox, source_visual_bbox_from_runs};
use crate::editor::debug_trace::{
    editor_debug_field as dbg_field, record_editor_debug_event as dbg_event,
};
use crate::utils::bbox::{bbox_height, bbox_width};
use crate::utils::debug::truncate_debug_text;

pub(crate) fn original_paint_runs_for_target(
...
pub(crate) fn resolve_preferred_editor_session(
    paragraph: &GlyphPaintParagraph,
...
fn layout_run_from_glyph_paint(run: &GlyphPaintRun, run_index: usize) -> LayoutRun {
    LayoutRun {
        ...
        text: run.text.clone(),
        style: pdf_viewer_core::models::RunStyle {
