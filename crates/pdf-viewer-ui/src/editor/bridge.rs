use crate::editor::document_plan::collect_editor_document_target_plans;
...
use crate::editor::source_identity::collect_object_indices_from_runs;
use crate::models::PersistableRegionPatch;
use crate::editor::paragraph_scene::build_paragraph_editor_scene_for_target;
use crate::editor::paragraph_scene::ParagraphEditorScene;
use pdf_viewer_core::models::{GlyphPaintParagraph, GlyphPaintPlan, VectorPageModel};
...
pub struct ParagraphInteractionTarget {
    ...
    pub bbox: pdf_viewer_core::models::BoundingBox,
...
fn resolve_target_indices_from_runs(
    runs: &[pdf_viewer_core::models::GlyphPaintRun],
    vector_model: Option<&VectorPageModel>,
) -> Vec<usize> {
