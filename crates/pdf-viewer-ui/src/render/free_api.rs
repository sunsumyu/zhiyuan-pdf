...
use crate::render::platform_bridge::{
    advance_frame as inner_advance_render_loop_frame, queue_frame as inner_queue_render_loop_frame,
};
...
use crate::zoom::preview_host::{
    ...
    set_pending as inner_set_wheel_render_pending, take_frame as inner_take_ready_committed_frame,
};
