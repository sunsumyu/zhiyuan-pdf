...
use pdf_viewer_core::models::{LayoutParagraph, LayoutRun, RunStyle};
...
mod tests {
    use super::*;
    use pdf_viewer_core::models::{BoundingBox, LayoutParagraph, LayoutRun, RunStyle};
    ...
    fn test_deletion_multi_byte_chinese() {
        // "专业：" 是 3个中文字符+1个全角冒号，共 4*3=12 字节 (UTF-8)
