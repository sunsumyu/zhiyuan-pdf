...
use crate::infrastructure::multimedia::pdf::pdf_font::{ParsedFont, resolve_glyph_geom, ResourceCache, simplify_path_segments, read_cmap};
            ...
            "Tf" => {
                if let Some(name) = op.operands.get(0).and_then(|o| o.as_name().ok()) {
                    ...
                    if let Some(font_id) = flat_resources.get(b"Font" as &[u8]).and_then(|m| m.get(name)) {
                        ...
                        else if let Ok(parsed) = crate::infrastructure::multimedia::pdf::pdf_font::parse_font_from_dict(doc, *font_id, name) {
...
pub fn extract_metadata(doc: &Document) -> Result<crate::infrastructure::multimedia::pdf::models::PdfMetadata, String> {
    let mut meta = crate::infrastructure::multimedia::pdf::models::PdfMetadata::default();
...
pub fn extract_vector_page_model(doc: &Document, page_index: u16) -> Result<crate::infrastructure::multimedia::pdf::models::VectorPageModel, String> {
    crate::infrastructure::multimedia::pdf::vector_engine::get_vector_page_model_with_doc(doc, page_index)
}

pub fn extract_layout_inference(doc: &Document, page_index: u16) -> Result<crate::infrastructure::multimedia::pdf::models::LayoutInferenceResult, String> {
    crate::infrastructure::multimedia::pdf::vector_engine::get_layout_inference(doc, page_index)
}

pub fn extract_glyph_paint_plan(doc: &Document, page_index: u16) -> Result<crate::infrastructure::multimedia::pdf::models::GlyphPaintPlan, String> {
    ...
    let mut glyph_paint_plan = crate::infrastructure::multimedia::pdf::models::GlyphPaintPlan {
        page_index,
        width,
        height,
        ..Default::default()
