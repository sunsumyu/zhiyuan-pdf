use crate::infrastructure::multimedia::pdf::models::{NativeTextModel, RenderObject};
...
pub struct VelloRenderer {
    ...
    font_matcher: crate::infrastructure::multimedia::pdf::font_matching::PdfSystemFontMatcher,
}
impl VelloRenderer {
pub async fn new() -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            font_matcher: crate::infrastructure::multimedia::pdf::font_matching::PdfSystemFontMatcher::new(
                crate::infrastructure::multimedia::pdf::font_catalog::load_system_font_candidates(),
                "Microsoft YaHei",
            ),
        })
    }
...
fn draw_image_cpu(
        ...
        model: &crate::infrastructure::multimedia::pdf::models::NativeImageModel,
        zoom: f32,
        canvas_w: u32,
        canvas_h: u32,
    ) {
...
fn draw_embedded_text_vector(
        ...
        let font_bytes = {
            let cache = crate::infrastructure::multimedia::pdf::models::PDF_FONT_PROGRAM_CACHE
                .lock()
                .unwrap();
...
fn resolve_cached_cid_glyph_id(&self, text: &NativeTextModel, raw_code: u32) -> Option<u16> {
        ...
        let cache = crate::infrastructure::multimedia::pdf::models::PDF_FONT_GLYPH_MAP_CACHE
            .lock()
            .ok()?;
