...
use crate::infrastructure::multimedia::pdf::domain::{
...
impl PdfReadService {
    ...
    pub(crate) async fn get_pdf_metadata_from_app_state(
        ...
        crate::infrastructure::multimedia::pdf::pdf_read::extract_metadata(doc)
    ...
    pub(crate) async fn get_vector_page_model_from_app_state(
        ...
        crate::infrastructure::multimedia::pdf::pdf_read::extract_vector_page_model(
            doc, page_index,
        )
    ...
    pub async fn get_layout_inference(
        ...
        crate::infrastructure::multimedia::pdf::pdf_read::extract_layout_inference(
            doc, page_index,
        )
    ...
    pub async fn get_glyph_paint_plan(
        ...
        crate::infrastructure::multimedia::pdf::pdf_read::extract_glyph_paint_plan(
            doc, page_index,
        )
    ...
    pub async fn create_document(
        ...
        let page_count = crate::infrastructure::multimedia::pdf::pdf_read::get_page_count(doc)
            .map_err(|e| DomainError::PdfProcessingError(e.to_string()))?;
        
        // 创建文档元数据
        let domain_metadata = crate::infrastructure::multimedia::pdf::domain::DocumentMetadata::new()
        ...
        for page_idx in 1..=page_count {
            ...
            // 获取页面边界框
            let page_bbox = crate::infrastructure::multimedia::pdf::pdf_read::extract_page_bbox(doc, page_idx as u16)
                .map_err(|e| DomainError::PdfProcessingError(e.to_string()))?;
