use crate::infrastructure::multimedia::pdf::layout_analyzer::LayoutGraphAnalyzer;
...
pub fn get_vector_page_model_with_doc(
    ...
    let (mut render_objects, text_runs, pw, ph) =
        match crate::infrastructure::multimedia::pdf::pdf_read::resolve_paths(
            &doc,
            page_index as u32,
        ) {
            Ok(res) => {
    ...
    {
use crate::infrastructure::multimedia::pdf::models::{LayoutAlignment, LayoutRole};
...
use rayon::prelude::*;
    ...
    let palette = crate::infrastructure::multimedia::pdf::models::VectorPalette {
