...
use crate::infrastructure::pdf::engine::{PdfDocumentService, PdfEditorGeometryService, PdfPageModelService};
...
use crate::infrastructure::pdf::commands::PdfEditCommand;
use crate::infrastructure::pdf::commands::ReplaceTextCommand;
...
pub async fn render_tile(
    ...
    let (mut objects, runs, _pw, _ph) = {
        ...
        crate::infrastructure::pdf::pdf_read::resolve_paths(
            doc,
            page_index as u32,
        )
    ...
    // [SLOT V3] Merge text runs into objects for the rendereruse crate::infrastructure::pdf::models::{NativeTextModel, RenderObject};
    for run in runs {
        let text_id = run
            .object_id
            .clone()
